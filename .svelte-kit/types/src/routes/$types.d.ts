...
type LayoutRouteId = RouteId | "/" | "/[[lang]]/about" | "/image/[width]x[height]" | "/login" | "/media/[...file]/[width]/[height]" | "/posts" | "/posts/[slug]" | "/posts/create" | "/todos" | null
type LayoutParams = RouteParams & { lang?: string,width?: string,height?: string,file?: string,slug?: string }
